...
<head>
	<link rel="canonical" href="http://localhost/Website/s.php">
    ...
    <header>
        <div class="container header">
            <div class="intro-text">
                <div class="intro-lead-in">If accepted you will be notified by e-mail in a week!</div>
                <div class="intro-heading">SUCCESSFULLY UPLOADED</div>
                <a href="#services" class="page-scroll btn btn-xl">GO BACK</a>
            </div>
        </div>
    </header>
