...
<head>
	<link rel="canonical" href="http://localhost/Website/f.php">
...
.header {
  width: 100%;
  height: 100%;
  background: url(img/warning.jpg) center center no-repeat;
    ...
    <header>
        <div class="container header">
            <div class="intro-text">
                <div class="intro-lead-in">Please try again</div>
                <div class="intro-heading">ERROR IN UPLOADING!</div>
                <a href="login_write.php" class="btn btn-xl">GO BACK</a>
            </div>
        </div>
    </header>
