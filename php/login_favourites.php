...
<head>
	<link rel="canonical" href="http://localhost/Website/login_favourites.php">
...
.header {
  width: 100%;
  height: 100%;
  background: url(img/bookmark.jpg) center center no-repeat;
        ...
        <div class="container header">
            <div class="intro-text">
             <!--   <div class="intro-lead-in"></div>-->
                <div class="intro-heading">BOOKMARKS</div>
		...
		<div id="image-grid">
			<div class="row">
				...
				<div class=" col-md-4 img wrapper"> 
					...
					<?php
					require "conn.php";
					$name=trim($_SESSION['myValue']);
					
					
					$mysql_qry="select Pic_no from favourites where User='$name';";
