...
<head>
	<link rel="canonical" href="http://localhost/Website/login_badgeList.php">
    ...
    <header>
         <div class="container header">
            <div class="intro-text">
                ...
                <a href="login_write.php" class="btn btn-xl">UPLOAD ARTICLES</a>
            </div>
        </div>
    </header>
...
<div class="list-group">
 <div class="row">
	<div class=" col-md-3 ">
		...
		<div class=" col-md-9 "> 
  <a href="http://localhost/Website/login_content_read.php" class="list-group-item list-group-item-warning list-group-item-action flex-column align-items-start ">
  ...
  <div class="row">
	...
	<div class=" col-md-9 "> 
		<a href="http://localhost/Website/login_content_read.php" class="list-group-item  list-group-item-action flex-column align-items-start">
		<div class="d-flex w-100 justify-content-between">
