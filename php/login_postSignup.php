...
<div class=" text-center">    
						...
						<div class="alert alert-success" role="alert">Login Using your New Details!</div>
</div>
                        ...
                        <div class="panel-body" >
                            <form  action="http://localhost/Website/signup.php" method="POST" id="signupform" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="first" class="form-control" name="first" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="form-group">
